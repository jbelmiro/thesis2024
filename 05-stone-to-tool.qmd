...
hypotheses <- readr::read_csv(here::here('data/raw_data_from-stone-to-tool/hypotheses_short.csv'))
...
knitr::include_graphics(here::here("figures/from-stone-to-tool/VB_map.png"))
...
knitr::include_graphics(here::here("figures/from-stone-to-tool/types_short.png"))
...
## Technological data
gravettian_tech <- read_csv(here::here('data/raw_data_from-stone-to-tool/VBT_6_7_JB.csv'))
proto_tech <- read_csv(here::here('data/raw_data_from-stone-to-tool/VBT_4E_5_JB.csv'))
solutrean_JC <- read_csv(here::here('data/raw_data_from-stone-to-tool/VBR_ABC_JC.csv'))
solutrean_points <- read_csv(here::here('data/raw_data_from-stone-to-tool/shelter_points_JC.csv'))

## RM data
shelter_RM <- read_csv(here::here('data/raw_data_withinandbeyond/MACRO_IND_SHELTER.csv')) # Shelter RM analysis
terrace_RM <- read_csv(here::here('data/raw_data_withinandbeyond/MACRO_IND_TERRACE.csv')) # Terrace RM analysis
...
p_results <- readr::read_csv(here::here('data/raw_data_from-stone-to-tool/results_sum.csv'))
